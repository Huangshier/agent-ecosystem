...
## Maintenance Notes
- Shared template changes originate from `skills/project-bootstrap/assets/knowledge-hub-template/` and are synced into the installed hub.
...
- `project-bootstrap/assets/knowledge-hub-template/` owns shared project templates.
