...
| [`directory-index-health/`](directory-index-health/) | Covers opt-in missing-index warnings, direct-file thresholds, and reparse-point exclusion. | Active; phase 1 was introduced by PR #234 under issue #217. | [Family notes](directory-index-health/README.md), [directory index reference](../../../skills/memory-governance/references/directory-index-template.md) | 2026-07-11 |
